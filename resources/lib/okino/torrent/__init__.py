...
from okino.common import LocalizedEnum, LocalizedError
...
class Torrent:
    def __init__(self, url=None, data=None, file_name=None, http_client=None):
        """
        :type data: str
        :type url: str
    ...
    def data(self):
        if self._data is None:
            if self.has_url():
                ...
                try:
                    self._data = self.http_client.fetch(self.url).body
